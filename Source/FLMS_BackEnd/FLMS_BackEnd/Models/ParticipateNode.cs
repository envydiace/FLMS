...
namespace FLMS_BackEnd.Models
{
    public partial class ParticipateNode
    {
        ...
        {
            InverseParent = new HashSet<ParticipateNode>();
        ...
        public virtual ParticipateNode? Parent { get; set; }
        public virtual ICollection<ParticipateNode> InverseParent { get; set; }
